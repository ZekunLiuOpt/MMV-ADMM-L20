...
%
% Output: 
%         X: the reconstructed sparse matrix
% gamma_ind: the indexes of nonzero
% gamma_est: the final values of all the gamma_ind (including zeros)
%     count: the number of iterations used 
%
% Written by Zhilin Zhang, David Wipf, 05/12/2011
% (https://github.com/JustinGirard/MatlabCISL/blob/master/MFOCUSS.m)
%
% Reference: 
